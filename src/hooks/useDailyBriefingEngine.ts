...
/**
 * One-line coaching prompt rendered above "YOU SHOULD DO".
 * Generated by deterministic gates only — never AI-authored, never
 * monetary. Used for Stylist Privacy Contract empty-goals nudge.
 */
export interface CoachNudge {
  id: string;
  label: string;
  /** DOM id of the section to scroll to on click. */
...
export interface DailyBriefingEngineData {
  ...
  atRiskCents: number;
  /** Deterministic one-line coaching prompts (e.g., "set your goals"). */
