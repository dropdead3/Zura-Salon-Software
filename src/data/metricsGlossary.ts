...
export const metricsGlossary: MetricDefinition[] = [
  ...
  },
  {
    ...
    dataSource: 'phorest_transaction_items + phorest_appointments',
  ...
  // Leaderboard
  {
    ...
    dataSource: 'phorest_appointments + phorest_transaction_items',
  ...
  },
  {
    ...
    dataSource: 'phorest_transaction_items',
    updateFrequency: 'Weekly',
    example: '$1,250',
