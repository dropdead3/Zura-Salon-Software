        ...
        <PlatformCardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <PlatformCardDescription>Four steps from detection to activation</PlatformCardDescription>
            </div>
          </div>
        </PlatformCardHeader>
        <PlatformCardContent>
          <StepRow number={1} title="Detection" description="Zura continuously analyzes operational data — revenue trends, utilization, service mix — to detect growth opportunities." />
          <StepRow number={2} title="Scoring" description="Opportunities are scored and filtered. Only high-confidence, high-return opportunities pass. Low-quality signals are suppressed." />
          <StepRow number={3} title="Surfacing" description="Qualifying opportunities appear in the organization's Growth Hub under Zura Capital." />
          <StepRow number={4} title="Activation" description="The organization admin reviews the opportunity and decides whether to activate funding." />
        </PlatformCardContent>
      </PlatformCard>
        ...
        <PlatformCardContent className="space-y-3">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-[hsl(var(--platform-foreground-muted))]">
              A "Zura Capital" link appears in the Growth Hub when the feature is enabled and at least one opportunity qualifies.
            </p>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle2 className="h-4 w-4 text-emerald-400 mt-0.5 shrink-0" />
            <p className="text-sm text-[hsl(var(--platform-foreground-muted))]">
              Admins see a ranked list of qualified opportunities. Each has a detail view and an activation option.
            </p>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle2 className="h-4 w-4 text-emerald-400 mt-0.5 shrink-0" />
            <p className="text-sm text-[hsl(var(--platform-foreground-muted))]">
              If nothing qualifies, the section stays empty. No false signals are surfaced.
            </p>
          </div>
        </PlatformCardContent>
      </PlatformCard>
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="q1" className="border-[hsl(var(--platform-border)/0.3)]">
              ...
              <AccordionContent className="text-sm text-[hsl(var(--platform-foreground-muted))]">
                No. Funding is provided by third-party partners like Stripe and is subject to their underwriting criteria and terms. Zura surfaces the opportunity — the provider handles everything else.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="q2" className="border-[hsl(var(--platform-border)/0.3)]">
              ...
              <AccordionContent className="text-sm text-[hsl(var(--platform-foreground-muted))]">
                Zura begins evaluating growth opportunities using operational data. When qualifying opportunities are found, they surface in the organization's Growth Hub.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="q4" className="border-[hsl(var(--platform-border)/0.3)]">
              ...
              <AccordionContent className="text-sm text-[hsl(var(--platform-foreground-muted))]">
                The section stays empty. Zura does not surface low-confidence or low-return signals. Silence is meaningful.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="q5" className="border-[hsl(var(--platform-border)/0.3)]">
              ...
              <AccordionContent className="text-sm text-[hsl(var(--platform-foreground-muted))]">
                Deterministic scoring based on projected return, data confidence, risk level, and operational stability. AI is not used for eligibility decisions.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="q6" className="border-[hsl(var(--platform-border)/0.3)]">
              ...
              <AccordionContent className="text-sm text-[hsl(var(--platform-foreground-muted))]">
                Funding terms are set by the provider (e.g., Stripe). Zura surfaces the opportunity; the provider handles underwriting, terms, and risk assessment.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </PlatformCardContent>
