    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-[680px] bg-slate-950/95 backdrop-blur-xl border border-white/[0.08] rounded-2xl shadow-2xl shadow-black/40 overflow-hidden"
        >
