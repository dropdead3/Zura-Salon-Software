 ...
 * subscription. Unentitled orgs see an upgrade stub routing to the marketplace.
 *
        ...
        <div className="flex items-start gap-5">
          ...
          <div className="flex-1 space-y-3">
            ...
            <p className="text-sm text-muted-foreground max-w-xl">
              ...
              5-star reviews directly into your website.
            </p>
            <div className="flex items-center gap-3 pt-2">
              <Button asChild>
                <Link to={dashPath('/apps?app=reputation')}>
