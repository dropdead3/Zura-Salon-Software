  ...
  return (
    <div className="space-y-4">
      ...
      <ScrollableTableWrapper>
        <Table className="[&_th]:border-r [&_th]:border-border/20 [&_th:last-child]:border-r-0 [&_td]:border-r [&_td]:border-border/20 [&_td:last-child]:border-r-0 [&_td[colspan]]:border-r-0 [&>div]:!overflow-visible">
