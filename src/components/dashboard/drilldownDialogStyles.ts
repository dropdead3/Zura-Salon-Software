...
/** Shared SheetContent className for Sheet-based drilldowns — luxury glass bento */
export const DRILLDOWN_SHEET_CONTENT_CLASS = 'bg-card/80 backdrop-blur-xl border-border shadow-2xl p-0';

/** Shared SheetOverlay className for Sheet-based drilldowns */
export const DRILLDOWN_SHEET_OVERLAY_CLASS = 'backdrop-blur-sm bg-black/40';
