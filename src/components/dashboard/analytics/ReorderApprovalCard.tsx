...
import { ClipboardCheck, Check, X, ShoppingCart, CheckCheck, Bot } from 'lucide-react';
import { cn } from '@/lib/utils';
import { formatDistanceToNow } from 'date-fns';
import { toast } from 'sonner';

function isAutoGenerated(po: any): boolean {
  return po.import_source === 'auto_reorder' || (typeof po.notes === 'string' && po.notes.toLowerCase().includes('auto'));
}
...
export function ReorderApprovalCard() {
  ...
  const handleBatchApprove = () => {
    ...
    toast.success(`${draftPOs.length} POs approved and sent`);
  };
            ...
            <div className="flex items-center gap-2">
              {draftPOs.length >= 2 && (
                <Button
                  size="sm"
                  variant="outline"
                  className="h-9 px-4 rounded-full text-xs font-sans font-medium text-emerald-600 border-emerald-200 hover:bg-emerald-50 dark:border-emerald-800 dark:hover:bg-emerald-950/20"
