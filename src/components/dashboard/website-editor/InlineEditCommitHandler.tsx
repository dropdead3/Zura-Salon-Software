      ...
      > = {
        section_hero: {
          ...
          allowedPaths: [
            ...
            'slides.*.eyebrow',
            'slides.*.subheadline_line1',
            'slides.*.subheadline_line2',
            'slides.*.cta_new_client',
            'slides.*.cta_new_client_url',
            'slides.*.cta_returning_client',
            'slides.*.cta_returning_client_url',
          ],
        },
