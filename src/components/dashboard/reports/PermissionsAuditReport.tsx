...
export function PermissionsAuditReport({ dateFrom, dateTo, locationId, onClose }: Props) {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const headerOpts = { orgName: businessSettings?.business_name || effectiveOrganization?.name || 'Organization', logoDataUrl, reportTitle: 'Permissions Audit Report', dateFrom: 'Current Snapshot', dateTo: today, locationInfo } as const;
