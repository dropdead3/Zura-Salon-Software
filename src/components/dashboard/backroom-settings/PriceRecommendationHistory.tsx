/**
 * PriceRecommendationHistory — Collapsible audit log of accept/dismiss actions.
 */
...
import { usePriceRecommendationHistory } from '@/hooks/backroom/useServicePriceRecommendations';
          ...
          {history.map((entry) => (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                >
                  {entry.status === 'accepted' ? 'Accepted' : 'Dismissed'}
                </Badge>
              ...
              <div className="text-[10px] text-muted-foreground font-sans shrink-0 ml-3">
