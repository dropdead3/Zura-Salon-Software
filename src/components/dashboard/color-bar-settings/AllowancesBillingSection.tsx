...
import { useBackroomBillingSettings, useUpsertBackroomBillingSettings } from '@/hooks/billing/useColorBarBillingSettings';
...
export function AllowancesBillingSection({ onNavigate }: Props) {
  ...
  const [showEducation, setShowEducation] = useState(!hasPolicies);
