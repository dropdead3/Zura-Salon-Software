                                ...
                                <TableCell onClick={(e) => e.stopPropagation()}>
                                  <div className="flex items-center gap-2 justify-end">
                                    ...
                                    {service.backroom_config_dismissed ? (
                                      ...
                                      (() => {
                                        const activePolicy = allowancePolicies?.find(p => p.service_id === service.id && p.is_active);
                                        return activePolicy?.billing_mode === 'parts_and_labor' ? (
                                          <Badge variant="outline" className="text-[10px] shrink-0 min-w-[6.5rem] justify-center border-violet-500/30 bg-violet-500/10 text-violet-500 dark:text-violet-400">Parts & Labor</Badge>
                                        ) : (
