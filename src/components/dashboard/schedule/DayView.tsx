  ...
  useEffect(() => {
    ...
    if (isZoomChange) {
      ...
      if (isToday && withinBusinessHours) {
        ...
        // Fallback: land on min(opening − 1h, firstAppt − 1h).
        ...
        for (const apt of appointments) {
          ...
          if (earliestApptHour === null || mins / 60 < earliestApptHour) {
            earliestApptHour = Math.floor(mins / 60);
          }
        }
                 ...
                 return (
                    ...
                    >
                      ...
                      {showCurrentTime && currentTimeOverlayPx > 0 && (
                        <div
                          className="absolute inset-x-0 top-0 bg-foreground/[0.16] dark:bg-muted/40 pointer-events-none z-[14]"
