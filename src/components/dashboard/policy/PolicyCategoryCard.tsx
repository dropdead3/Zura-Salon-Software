...
export function PolicyCategoryCard({ category, adopted, total, onClick }: Props) {
  ...
  return (
    ...
    >
      <Card className="rounded-xl border-border/60 bg-card/80 transition-colors group-hover:border-primary/40 group-hover:bg-card h-full">
