export const TABS_CLASSES = {
  ...
  filterList: "inline-flex h-8 items-center justify-center p-1 text-muted-foreground gap-1 bg-muted border border-border/70 dark:bg-muted/70 dark:border-transparent rounded-[7px]",
  filterTrigger: [
