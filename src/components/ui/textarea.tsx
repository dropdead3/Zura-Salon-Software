  ...
  return (
    <textarea
      className={cn(
        ...
        // clip into a lozenge. Use rounded-xl (12px) — softer than a square
        // input but visibly tighter than the single-line pill so the eye
        // reads "this field holds more than one line." Do not raise back to
        // rounded-2xl, and do not "fix" to rounded-full.
