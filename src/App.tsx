                ...
                <DashboardThemeProvider>
                  <ViewAsProvider>
                    <HideNumbersProvider>
                      ...
                      {/* ═══════════════════════════════════════════════════════════
                          ORG DASHBOARD — /org/:orgSlug/dashboard/*
                          (was /dashboard/*)
                         ═══════════════════════════════════════════════════════════ */}
                      <Route path="/org/:orgSlug/dashboard" element={<ProtectedRoute><OrgDashboardRoute /></ProtectedRoute>}>
                      ...
                      {/* ═══════════════════════════════════════════════════════════
                          LEGACY REDIRECTS — /dashboard/* → /org/:slug/dashboard/*
                         ═══════════════════════════════════════════════════════════ */}
