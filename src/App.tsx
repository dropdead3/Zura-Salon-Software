...
function DashboardRoutes() {
  return (
    <>
      ...
      <Route path="admin/homepage-stylists" element={<Navigate to="../website-hub" relative="path" replace />} />
      <Route path="admin/testimonials" element={<Navigate to="../website-hub" relative="path" replace />} />
      <Route path="admin/gallery" element={<Navigate to="../website-hub" relative="path" replace />} />
