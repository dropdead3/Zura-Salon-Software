...
SELECT
  ...
  -- Payment link fields (not applicable to phorest appointments)
  NULL::timestamptz AS payment_link_sent_at,
  NULL::text AS payment_link_url,
  NULL::timestamptz AS payment_link_expires_at,
  NULL::text AS split_payment_terminal_intent_id,
  NULL::text AS split_payment_link_intent_id,
...
SELECT
  ...
  a.payment_link_url,
  a.payment_link_expires_at,
  a.split_payment_terminal_intent_id,
  a.split_payment_link_intent_id,
  a.paid_at
FROM appointments a
